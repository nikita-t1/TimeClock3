...
public class HorizontalExpCalendar extends RelativeLayout implements PageView.PageViewListener, Animations.AnimationsListener {
  ...
  private Button calendarSwitchButton;
  ...
  private void initTopContainer() {
    ...
    calendarSwitchButton = (Button) findViewById(R.id.calendarSwitchButton);
    ...
    findViewById(R.id.calendarSwitchButton).setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View view) {
        if (!isLocked()) {
  ...
  public void switchToView(final Config.ViewPagerType switchTo) {
